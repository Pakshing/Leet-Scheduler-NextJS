    ...
    <div className="bg-gray-200 h-screen">
      <Navbar />
        <div className="content-section m-12 w-auto h-4/5 bg-theme-color text-center flex rounded-lg">
          <div className="intro-text flex-1 p-8 text-white items-center justify-center flex flex-col leading-10 w-full">
          ...
          <div className="img-section flex-1 flex items-center m-8 rounded-lg">
